function insertThankScript() {
    ...
    function activateOption(option) {
        ...
        let allOptionsButtons2 = option.parentElement.querySelectorAll(".grid-container-mobile");
        for (let i = 0; i < allOptionsButtons2.length; i++) {
            allOptionsButtons2[i].classList.remove("active");
            allOptionsButtons2[i].classList.add("inactive")
        }
